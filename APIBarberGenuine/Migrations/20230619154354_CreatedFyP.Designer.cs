...
namespace APIBarberGenuine.Migrations
{
    ...
    [Migration("20230619154354_CreatedFyP")]
    partial class CreatedFyP
    {
            ...
            modelBuilder.Entity("APIBarberGenuine.Models.Factura", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Description = "Venta",
                            Fecha = new DateTime(2023, 6, 19, 9, 43, 54, 342, DateTimeKind.Local).AddTicks(4459),
                            Total = 0m
                        },
                        new
                        {
                            Id = 2,
                            Description = "Venta",
                            Fecha = new DateTime(2023, 6, 19, 9, 43, 54, 342, DateTimeKind.Local).AddTicks(4471),
                            Total = 0m
                        },
                        new
                        {
